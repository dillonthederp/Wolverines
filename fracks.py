# -*- coding: utf-8 -*-
"""
Created on Fri Apr 28 13:42:49 2017
...
#need download appropraiate "'weelsKS.csv" file
...
#Split up various maps based on multiple time frames
...
for well in TWD:
        if well["Spud Year"]<"1950":
            T1.append(well)
            ALL.append(well)
        elif (well["Spud Year"]>="1950") & (well["Spud Year"]<"1970"):
            T2.append(well)
            ALL.append(well)
        elif (well["Spud Year"]>="1970") & (well["Spud Year"]<"1990"):
            T3.append(well)
            ALL.append(well)
        elif (well["Spud Year"]>="1990") & (well["Spud Year"]<"2000"):
            T4.append(well)
            ALL.append(well)
        elif (well["Spud Year"]>="2000") & (well["Spud Year"]<"2010"):
            T5.append(well)
            ALL.append(well)
        elif well["Spud Year"]>="2010":
            T6.append(well)
            ALL.append(well)
        else:
            print("EXTRA")
...
names = []
names.append("Pre-1950")
names.append("1950-1969")
names.append("1970-1989")
names.append("1990-1999")
names.append("2000-2009")
names.append("Post-2010")
names.append("ALL TIMES")
